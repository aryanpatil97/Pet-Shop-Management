...
public class AddDog {
	...
	private void initialize() {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(AddDog.class.getResource("/images/doge_meme.png")));
		frame.getContentPane().setBackground(new Color(224,247,250));
		frame.getContentPane().setLayout(null);
		
		JLabel lblNewLabel = new JLabel("Add Dog");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int status = jd.insertDog(Name, Breed, Age, Gender, Vaccination);
				if(status==1) {
